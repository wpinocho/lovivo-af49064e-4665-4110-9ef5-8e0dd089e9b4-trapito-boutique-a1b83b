...
import { articleJsonLd, breadcrumbJsonLd, plainText } from '@/lib/seo/jsonld'
...
const BlogPost = () => {
          ...
          result.push(
            <div key={`image-${imageIndex}`} className="my-8">
              <img 
                ...
                alt={`Imagen del artículo ${imageIndex}`}
            ...
            <CardContent className="pt-12 pb-12">
              <div className="text-center space-y-6">
                ...
                <div className="space-y-2">
                  <h3 className="font-semibold text-xl">Artículo no encontrado</h3>
  ...
  const seoDescription = plainText(blog.excerpt || blog.content, 160)
  const seoImage = blog.featured_image?.[0]
  ...
  return (
    <>
      <SEO
        ...
        ogType="article"
        storeName={storeName}
        jsonLd={[articleJsonLd(blog, storeName), breadcrumbs]}
      />
    <EcommerceTemplate showCart={true}>
